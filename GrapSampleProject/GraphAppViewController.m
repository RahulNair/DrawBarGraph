...
- (void)viewDidLoad
{
    ...
    NSArray *percentValueOfStudent_YELLOW = [[NSArray alloc]initWithObjects:[NSNumber numberWithInteger:5],[NSNumber numberWithInteger:10],[NSNumber numberWithInteger:0],[NSNumber numberWithInteger:40],[NSNumber numberWithInteger:75] ,nil];
    ...
    graphCanvas.max_percent_val = 80;
